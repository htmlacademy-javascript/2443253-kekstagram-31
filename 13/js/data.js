//----------------------------------------------------------------------------------------
//В данном модуле реализована создание случайного массива объектов,
//каждый из которых представляет пользовательское фото с описанием
//Эти данные нужны для подстановки вместо реальных данных, загружаемых с сервера
//----------------------------------------------------------------------------------------
